...
exports.modules = function mockCategoryModel(){
    ...
    const price = Number(Number(faker.finance.amount()).toFixed(2)).toLocaleString(["pt-Br"]);
    const totalPrice = Number(Number(faker.finance.amount(100, 10000)).toFixed(2)).toLocaleString(["pt-Br"]);
    const recipientAmount = faker.finance.amount(1, 100);
